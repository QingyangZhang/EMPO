...
class DataParallelPPOCritic(BasePPOCritic):
    ...
    def compute_values(self, data: DataProto) -> torch.Tensor:
        ...
        values_lst = []
        for micro_batch in tqdm(micro_batches, desc="Computing values", disable=not_rank_0):
    ...
    def update_critic(self, data: DataProto):
        ...
        for epoch in range(self.config.ppo_epochs):
            ...
            for batch_idx, data in tqdm(enumerate(dataloader), desc=f"Critic training epoch {epoch}", disable=not_rank_0):
