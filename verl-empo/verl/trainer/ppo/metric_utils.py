...
def calc_maj_val(data: list[dict[str, Any]], vote_key: str, val_key: str) -> float:
    ...
    for d in data:
        # Exclude entries where the vote_key's value is an empty string
        if d.get(vote_key) != "":
            ...
            for var_name, var_vals in var2vals.items():
                ...
                if n_resps > 1:
                    ...
                    for n in ns:
                        ...
                        if var2vals.get("extracted_pred", None) is not None:
                            vote_data = [{"val": val, "pred": pred} for val, pred in zip(var_vals, var2vals["extracted_pred"])]
