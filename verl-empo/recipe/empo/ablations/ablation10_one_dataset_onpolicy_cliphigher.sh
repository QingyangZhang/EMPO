...
exp_name='Ablation9-one-dataset-onpolicy-cliphigher'
...
MODEL_PATH=${MODEL_PATH:-"${RAY_DATA_HOME}/models/DeepSeek-R1-Distill-Qwen-7B"}
...
TRAIN_FILES="['$PHYSICS_train_path']"
TEST_FILES="['$gpqa_test_path','$OlympiadBench_test_path','$math_test_path']"
