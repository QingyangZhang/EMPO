...
exp_name="EMPO-Qwen2.5-Math-1.5B"
...
MODEL_PATH=${MODEL_PATH:-"/mnt/shared-storage-user/p1-shared/Qwen/Qwen2.5-Math-1.5B/snapshots/4a83ca6e4526a4f2da3aa259ec36c259f66b2ab2"}
...
TEST_FILES="['$amc23', '$minerva_math', '$math500']"
# TEST_FILES="['$amc23']"
...
HYDRA_FULL_ERROR=1 python3 -m recipe.empo.src.main_dapo \
    ...
    trainer.resume_from_path=/mnt/shared-storage-user/zhangqingyang/ckpts/EMPO/EMPO-Qwen2.5-Math-1.5B-060410/global_step_192 \
    trainer.resume_mode=resume_path 2>&1 | tee outputs/${exp_name}-6.log