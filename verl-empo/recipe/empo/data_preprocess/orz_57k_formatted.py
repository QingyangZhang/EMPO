...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, default='/fs-computility/mabasic/shared/data/p1/train/orz_math_38k_formatted.jsonl')
    parser.add_argument('--output_dir', type=str, default='/fs-computility/mabasic/shared/data/physics/sft_rl_data')
    data_source = 'orz_38k_formatted'
    ...
    dataset.to_parquet(os.path.join(args.output_dir, 'orz_38k_formatted.parquet'))

    print(f"Processed data saved to {os.path.join(args.output_dir, 'orz_38k_formatted.parquet')}")
