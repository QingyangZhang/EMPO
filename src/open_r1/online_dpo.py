...
from trl import OnlineDPOTrainer, OnlineDPOConfig, ModelConfig, ScriptArguments, TrlParser, get_peft_config
from trl import BasePairwiseJudge

logger = logging.getLogger(__name__)
system_prompt="You are a helpful AI Assistant that provides well-reasoned responses. You first think about the reasoning process as an internal monologue and then provide the answer within \\boxed{}."
...
def main(script_args, training_args, model_args):
    ...
    #############################
    # Initialize the OnlineDPO trainer
    #############################
